...
function PackagesPage() {
    ...
    const fetchPackages = async ()=>{
        try {
            const { data, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].from('packages').select('*').order('price', {
                ascending: true
            });
    ...
    const handleUpdate = async (updatedPkg)=>{
        try {
            const { error } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].from('packages').update({
...
//# sourceMappingURL=_ec7739ad._.js.map