...
function BookingDrawer({ booking, open, onClose, onEdit, onDelete, onSave }) {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "BookingDrawer.useEffect": ()=>{
            const fetchDrivers = {
                "BookingDrawer.useEffect.fetchDrivers": async ()=>{
                    setIsLoadingDrivers(true);
                    try {
                        const { data, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from('drivers').select('*').order('name');
                        if (error) {
                            console.error('Error fetching drivers:', error);
                            toast({
                                title: "Warning",
                                description: "Could not load drivers list. Using cached data.",
                                variant: "destructive"
                            });
                        } else {
                            setDrivers(data || []);
            ...
            }["BookingDrawer.useEffect.fetchDrivers"];
            if (open) {
                fetchDrivers();
            }
        }
...
_s(BookingDrawer, "5TWGSGC0lS7Lv3RUNwAuCsfBo0E=", false, function() {
    return [
...
function BookingWizard({ open, onClose, onSave, existingBookings }) {
            ...
            const fetchData = {
                "BookingWizard.useEffect.fetchData": async ()=>{
                    try {
                        ...
                        // Fetch Packages
                        const { data: packagesData, error: packagesError } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from('packages').select('title, price');
                        if (packagesError) console.error("Error fetching packages:", packagesError);
                        // Fetch Activities
                        const { data: activitiesData, error: activitiesError } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from('activities').select('title, price');
                        ...
                        if (activitiesData && activitiesData.length > 0) {
                            setActivities(activitiesData.map({
                                "BookingWizard.useEffect.fetchData": (a)=>({
                                        ...a,
    ...
    const selectedItem = [
        ...packages,
        ...activities
    ].find((i)=>i.title === formData.package_title);
    ...
    const handleSubmit = async ()=>{
        ...
        try {
            const driver = __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$mock$2d$data$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["mockDrivers"].find((d)=>d.id === formData.driver_id);
                                                    ...
                                                    children: [
                                                        ...
                                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$ui$2f$select$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["SelectGroup"], {
                                                            children: [
                                                                ...
                                                                activities.map((act)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$ui$2f$select$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["SelectItem"], {
                                                                        value: act.title,
                                                                        children: [
                                                                            act.title,
                                                                            " - ",
                            ...
                            children: [
                                ...
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                    ...
                                    children: [
                                        ...
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                            className: "space-y-2",
                                            children: __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$mock$2d$data$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["mockDrivers"].map((driver)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                    onClick: ()=>{
...
_s(BookingWizard, "wHmtJ1kgCOQiwQQneYuM5e4Vhmg=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$hooks$2f$use$2d$toast$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useToast"],
        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$navigation$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRouter"]
    ];
...
//# sourceMappingURL=_f001da93._.js.map